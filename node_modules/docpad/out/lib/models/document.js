  ...
  DocumentModel = (function(_super) {
    ...
    DocumentModel.prototype.parse = function(opts, next) {
      ...
      DocumentModel.__super__.parse.call(this, opts, function() {
        var body, content, err, header, key, match, meta, metaDataChanges, parser, regex, seperator, _i, _j, _len, _len1, _ref2, _ref3, _ref4, _ref5;
        meta = _this.getMeta();
        metaDataChanges = {};
          ...
          try {
            switch (parser) {
              ...
              case 'yaml':
                ...
                metaDataChanges = YAML.parse(header.replace(/\t/g, '    '));
                break;
              default:
