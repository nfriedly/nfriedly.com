...
(function() {
  var Backbone, FileModel, Model, TaskGroup, docpadUtil, encodingUtil, extendr, extractOptsAndCallback, isTextOrBinary, jschardet, mime, pathUtil, safefs, typeChecker, _ref,
  ...
  FileModel = (function(_super) {
    ...
    FileModel.prototype.parse = function(opts, next) {
      var buffer, changes, content, d, encoding, err, isText, relativePath, source, _ref1, _ref2;
      if (opts == null) {
        opts = {};
      }
      _ref1 = extractOptsAndCallback(opts, next), opts = _ref1[0], next = _ref1[1];
