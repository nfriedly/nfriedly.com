  ...
  DocPad = (function(_super) {
    ...
    DocPad.prototype.getVersionString = function() {
      if (docpadUtil.isLocalDocPadExecutable()) {
        return util.format(this.getLocale().versionLocal, this.getVersion());
      } else {
        return util.format(this.getLocale().versionGlobal, this.getVersion());
      }
    };
    ...
    DocPad.prototype.renderFiles = function(opts, next) {
      ...
      renderCollection = function(collectionToRender, _arg, next) {
        ...
        return docpad.emitSerial('renderCollectionBefore', {
          ...
          //console.log('rendered: ', slowFilesObject[file.id]);
                var _ref2;
