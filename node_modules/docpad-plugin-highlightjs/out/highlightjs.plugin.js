...
(function() {
  ...
  module.exports = function(BasePlugin) {
    var HighlightjsPlugin, balUtil, cache, extendr, hljs;
    ...
    return HighlightjsPlugin = (function(_super) {
      ...
      HighlightjsPlugin.prototype.highlightSource = function(opts) {
        var aliases, className, config, docpad, err, escape, language, next, removeIndentation, replaceTab, result, source, transform, transforms, _i, _len, _ref;
        docpad = this.docpad;
        ...
        result = ("<pre class=\"" + className + "\"><code class=\"hljs " + language + "\">" + result + "</code></pre>").replace(/\t/g, replaceTab);
        next(null, result);
        return this;
      };

      HighlightjsPlugin.prototype.renderDocument = function(opts, next) {
        var cacheKey, cacheResult, className, extension, file, plugin, _ref;
